...
class BusSchedule(BaseModel):
    ...
    pickup_point: List[str] = Field(
        ...
        description="""The values of location where user wants to catch the bus.\n
                    This includes only the following names: \n
                    1. (for bus route Hai Ba Trung) 51 Le Dai Hanh, Times City, AEON Mall Long Bien, BUV Campus.\n
                    2. (for bus route Cau Giay) Nguyen Quoc Tri, National Cinema Centre, BUV Campus.\n
                    3. (for bus route Ha Dong) Ho Guom Plaza, Nguyen Trai, Muong Thanh Grand Hotel, Linh Nam, BUV Campus.\n
                    4. (for bus route Tay Ho) Ho Tay Water Park, Nghi Tam, Tran Khanh Du, Vinhomes Ocean Park, BUV Campus.\n
                    5. (for bus route Ecopark) Sky Oasis, Sol Forest, Landmark, Swanlake, Westbay – B Building, Westbay – C Building, Aquabay - Sky 2 Building, Aquabay – Park 1 - Building, Rung Co - E2 Building, BUV Campus.\n\n
    ...
    dropoff_point: List[str] = Field(
        ...
        description="""The values of destination where the user wants to go.\n
                    ...
                    4. (for bus route Tay Ho) Ho Tay Water Park, Nghi Tam, Tran Khanh Du, Vinhomes Ocean Park, BUV Campus.\n
                    5. (for bus route Ecopark) Sky Oasis, Sol Forest, Landmark, Swanlake, Westbay – B Building, Westbay – C Building, Aquabay - Sky 2 Building, Aquabay – Park 1 - Building, Rung Co - E2 Building, BUV Campus.\n
                    If the drop-off point is not mentioned in user's query, leave this field blank.""")
